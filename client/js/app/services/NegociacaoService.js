...
System.register(["./ConnectionFactory", "../models/Negociacao", "./HttpService", "../dao/NegociacaoDao"], function (_export, _context) {
  "use strict";

  var ConnectionFactory, Negociacao, HttpService, NegociacaoDao, NegociacaoService;
